...
public class NavegacaoLogin {

	public static boolean Login(WebDriver driver, String usuario, String senha, String evidenciaTeste) {
		...
		String tituloPagina = "login-" + h + m + s;
